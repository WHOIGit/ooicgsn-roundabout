...
'use strict';
console.log("Running Export Cruise/Vessel (non-CI) Test.");
...
(async function exportCruise() {
	...
	console.log("Add a Cruise.");
        ...
        // Export Cruise and Vessel - non CI Version
	...
	found = false;	
	  ...
	  if (exported_data[i][1] == "Maui Princess") {
		...
		(exported_data[i][2] == "Sunset Cruise") &&
		(exported_data[i][3] == "Test") &&
                (exported_data[i][4] == "2020-11-04T00:00:00") &&
                (exported_data[i][5] == "2021-01-03T00:00:00") &&
                (exported_data[i][6] == "Sunset Cruise."))
            {
	...
	if (!found) console.log("Export Cruise Fields Do Not Match.");
        ...
        console.log("Export Cruise/Vessel (non-CI) Test failed.");
        return 1;
    }
    console.log("Export Cruise/Vessel (non-CI) Test completed.");
    return 0;
