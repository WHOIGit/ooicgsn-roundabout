...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                ...
                'roundabout.core.context_processors.template_set_app_labels',
                'roundabout.core.context_processors.template_resolver_names',
                'roundabout.core.context_processors.template_get_env_variables',
            ],
        },
    },
]
