...
class Vessel(models.Model):
    ...
    length = models.DecimalField(max_digits=4, decimal_places=1, null=True)
    max_speed = models.DecimalField(max_digits=3, decimal_places=1, null=True)
    max_draft = models.DecimalField(max_digits=3, decimal_places=1, null=True)
    ...
    R2R = models.BooleanField(choices=BOOLEAN_CHOICES, null=True, default=True)
